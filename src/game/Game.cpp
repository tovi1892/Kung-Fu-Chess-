...
#include <cmath>
#include <utility> 
#include <memory>  // <-- תיקון: נדרש עבור std::shared_ptr ו-std::make_unique

#include "board/Board.hpp"
#include "common/GameConfig.hpp"
#include "pieces/Queen.hpp"
#include "rules/RuleEngine.hpp"
#include "game/RealTimeArbiter.hpp" // <-- תיקון: נדרש כדי שהקומפיילר יכיר את RealTimeArbiter

// הערה: אם הקומפיילר עדיין לא מזהה את CollisionSystem, 
// ודא שאתה מוסיף כאן את ה-Include המדויק שלו, לדוגמה:
